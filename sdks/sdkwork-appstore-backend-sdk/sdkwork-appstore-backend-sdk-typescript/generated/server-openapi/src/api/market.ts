...
export interface MarketAppstoreMarketReleasesListParams {
  releaseId?: string;
  channelId?: string;
  marketStatus?: string;
  cursor?: string;
...
export interface MarketAppstoreMarketReleasesSyncParams {
  idempotencyKey: string;
}

export class MarketAppstoreMarketReleasesApi {
...
export interface MarketAppstoreMarketChannelsListParams {
  channelStatus?: string;
  cursor?: string;
  pageSize?: number;
}

export class MarketAppstoreMarketChannelsApi {
  private client: HttpClient;
...
export function createMarketApi(client: HttpClient): MarketApi {
  return new MarketApi(client);
}
