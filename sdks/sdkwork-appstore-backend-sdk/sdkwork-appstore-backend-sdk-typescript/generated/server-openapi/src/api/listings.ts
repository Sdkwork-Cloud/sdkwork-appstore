...
export class ListingsAppstoreListingsAdminVisibilityApi {
...
export class ListingsAppstoreListingsAdminApi {
  private client: HttpClient;
  public readonly visibility: ListingsAppstoreListingsAdminVisibilityApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.visibility = new ListingsAppstoreListingsAdminVisibilityApi(client);
  }
