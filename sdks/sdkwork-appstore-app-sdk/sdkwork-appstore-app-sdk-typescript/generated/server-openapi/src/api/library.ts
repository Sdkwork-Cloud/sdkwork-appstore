...
export class LibraryAppstoreLibraryUpdatesApi {
...
export interface LibraryAppstoreLibraryItemsListParams {
  cursor?: string;
  pageSize?: number;
}

export class LibraryAppstoreLibraryItemsApi {
  private client: HttpClient;
...
export interface LibraryAppstoreLibraryInstallParams {
  idempotencyKey: string;
}

export class LibraryAppstoreLibraryApi {
  private client: HttpClient;
  public readonly items: LibraryAppstoreLibraryItemsApi;
  public readonly updates: LibraryAppstoreLibraryUpdatesApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.items = new LibraryAppstoreLibraryItemsApi(client);
    this.updates = new LibraryAppstoreLibraryUpdatesApi(client);
  }
