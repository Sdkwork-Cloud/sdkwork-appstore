...
VALUES
    ('lib-1', '100001', '1', 'app-wechat', 'app-wechat', 'installed', 'rel-app-wechat-8020', '8020', 'storefront', 'pc', 'x64', 'dev-pc-001', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, CURRENT_TIMESTAMP),
    ('lib-2', '100001', '1', 'app-wps', 'app-wps', 'installed', 'rel-app-wps-1270', '1270', 'storefront', 'pc', 'x64', 'dev-pc-001', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, CURRENT_TIMESTAMP),
    ('lib-3', '100001', '1', 'app-qwen', 'app-qwen', 'installed', 'rel-app-qwen-310', '310', 'storefront', 'pc', 'x64', 'dev-pc-001', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, CURRENT_TIMESTAMP),
    ('lib-4', '100001', '1', 'app-deepseek', 'app-deepseek', 'installed', 'rel-app-deepseek-140', '140', 'storefront', 'pc', 'x64', 'dev-pc-001', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, CURRENT_TIMESTAMP),
    ('lib-5', '100001', '1', 'app-cursor', 'app-cursor', 'installed', 'rel-app-cursor-0410', '0410', 'storefront', 'pc', 'x64', 'dev-pc-001', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, CURRENT_TIMESTAMP),
    ('lib-6', '100001', '1', 'app-doubao', 'app-doubao', 'installed', 'rel-app-doubao-220', '220', 'storefront', 'pc', 'x64', 'dev-pc-001', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, CURRENT_TIMESTAMP),
    ('lib-7', '100001', '1', 'app-tencent-ima', 'app-tencent-ima', 'installed', 'rel-app-tencent-ima-250', '250', 'storefront', 'pc', 'x64', 'dev-pc-001', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, CURRENT_TIMESTAMP),
    ('lib-8', '100001', '1', 'game-doudizhu', 'game-doudizhu', 'installed', 'rel-game-doudizhu-810', '810', 'storefront', 'pc', 'x64', 'dev-pc-001', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, CURRENT_TIMESTAMP),
    ('lib-9', '100001', '1', 'app-midjourney', 'app-midjourney', 'installed', 'rel-app-midjourney-600', '600', 'storefront', 'pc', 'x64', 'dev-pc-001', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, CURRENT_TIMESTAMP),
    ('lib-10', '100001', '1', 'app-kimi', 'app-kimi', 'installed', 'rel-app-kimi-280', '280', 'storefront', 'pc', 'x64', 'dev-pc-001', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, CURRENT_TIMESTAMP)
