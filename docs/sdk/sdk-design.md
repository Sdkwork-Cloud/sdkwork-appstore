...
apis/{surface}/store/openapi.yaml
        â”?
        â–? tools/appstore_openapi_materialize.mjs
sdks/sdkwork-appstore-*-sdk/openapi/sdkwork-appstore-*-api.openapi.yaml
        â”?
        â–? tools/appstore_sdk_generate.mjs  â†? sdkgen
...
```typescript
// Illustrative composed facade boundary â€?generated in implementation phase
