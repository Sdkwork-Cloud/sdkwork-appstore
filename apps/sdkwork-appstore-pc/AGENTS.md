...
- Application id: `sdkwork-appstore-pc`
- Surface: PC browser application
...
- `packages/`: PC application packages.
...
- Frontend/package boundaries: `FRONTEND_CODE_SPEC.md`, `FRONTEND_SPEC.md`, `UI_ARCHITECTURE_SPEC.md`, `APP_PC_ARCHITECTURE_SPEC.md`, `COMPOSABLE_ARCHITECTURE_SPEC.md`.
...
Keep bootstrap, services, reusable packages, and UI responsibilities separated. Business services receive composed SDK clients; UI does not construct HTTP clients or auth headers.
